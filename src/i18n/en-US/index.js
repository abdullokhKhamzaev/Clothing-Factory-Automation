export default {
  statistics: {
    modelView: 'By product',
    materialView: 'By material',
    userView: 'By employee',
    customerView: 'By customer',
    ...
    weave: {
      ...
      donePending: 'Woven (pending)',
      title: 'Woven products:',
      titlePending: 'Woven products (pending):',
    },
    sale: {
      salesTab: 'Sales',
    ...
    analytics: {
      ...
      sellThroughCaption: 'How much of the production in this period was sold',
      produced: 'Produced',
      sold: 'Sold',
      notProducedInPeriod: 'not produced in this period',
      topModels: 'Best selling models',
      topModelsCaption: 'With share of total sales',
      concentration: 'Customer concentration',
      concentrationCaption: 'How much of a model\'s sales one customer takes',
      topCustomers: 'Top customers',
      topCustomersCaption: 'Ranked by quantity and amount',
      stock: 'Warehouse stock',
      stockCaption: 'Current state of the products warehouse (not date-bound)',
      stockEmpty: 'No products in the warehouse',
      noData: 'No data for this period',
      noSales: 'No sales for this period',
      notSoldInPeriod: 'not sold in this period',
      soldBadge: 'sold',
      totalStock: 'Total stock',
      totalSold: 'Total sold',
      totalProduced: 'Total produced (Packaging)',
      debtors: 'Debtors',
      debtorsCaption: 'Customers with current debt (not date-bound)',
      debtorsEmpty: 'No debtors',
      debtSince: 'Oldest debt',
    },
    demand: {
      tab: 'Demand',
      title: 'Customer demand:',
      note: 'Based on orders entered in the Orders section',
      demandVsDelivered: 'Demand / Delivery',
      demandVsDeliveredCaption: 'Ordered vs sold quantities in this period',
      demand: 'Demand',
      delivered: 'Delivered',
      unmet: 'Unmet',
      fulfillment: 'Fulfillment',
      topModels: 'Most demanded models',
      topModelsCaption: 'With share of total ordered demand',
      byCustomers: 'By customers',
      byCustomersCaption: 'Each customer\'s demand and what was delivered',
      noData: 'No orders for this period',
    ...
    dashboard: {
      ...
      expensesNote: 'excl. salaries and exchange',
    },
  },
  transaction: {
    productCost: {
    ...
    orderAdvance: 'Order advance payment',
  ...
  sendToPackageWarehouse: 'Send to packaging',
  sendToProductsWarehouse: 'Send to products\' warehouse',
  waiting: 'Waiting',
  waitingOrders: 'Waiting orders',
  receive: 'Receive',
  cutter: 'Cutter',
  cutterService: 'Cutting Service',
  embroideryService: 'Embroidery Service',
  embroidery: 'Embroidery',
  sewer: 'Sewer',
  sewerService: 'Sewing Service',
  packager: 'Packager',
  packagerService: 'Packaging Service',
  monthly: 'Monthly',
  service: 'Service',
  daily: 'Daily',
  made: 'Made',
  ...
  orderActions: {
    ...
    cancel: 'Cancel order',
    closeConfirm: 'Close this order as delivered?',
  ...
  warehouses: {
    ...
    sewerReadyWarehouse: 'Sewer Ready Warehouse',
